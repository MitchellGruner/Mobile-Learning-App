...
const Lessons = ({ navigation, route }) => {
  ...
  async function createLesson(lesson) {
    ...
    // TEMPORARY, just placeholders for Reading and Video segments
    lesson.reading = 'https://drive.google.com/file/d/130FKKdzOV29VRTSDK4RcoQ_xBtHNbjBF/view?usp=sharing';
    lesson.video = 'https://www.youtube.com/watch?v=NpEaa2P7qZI';
